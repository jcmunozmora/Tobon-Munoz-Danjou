...
sort codmpio year
merge m:1 codmpio using "data/instruments.dta"
drop if _merge==2
drop _merge
...
keep litrate coca_presence aptitud erosion discapital rurality_index mdi depto municipio codmpio coddepto year inv_educacion_cp inv_salud_cp inv_justicia_cp ba_nu1000 g_uaf htapropietario health_coverage informalidad new_hom_rate coca_prop1000 alturakm dismdo 
...
foreach i in litrate coca_prop1000 informalidad mdi new_hom_rate $geo $land $pol $social {
